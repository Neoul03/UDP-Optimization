...
### 성능 기준점 (6.6.9-udprx3, 1코어, MTU 9000)
- TCP 최적: **39.6 G** (iperf3 3.20 기준. 구 36.5G 는 배포판 3.19 혼용 오류)
- UDP 최대 기댓값: **48.5 G** @ offered 52G, busy 100% (best case 51.7G 는 인용 금지)
- MTU 1500: Linux 기본(rmem 208K) 21-22G → 튜닝(rmem ≥512K) 32G, TCP 33.1G
- app GRO 레버: MTU 9000 에서 85%→65% busy, **MTU 1500 에서 100%→65%** (더 큼)
